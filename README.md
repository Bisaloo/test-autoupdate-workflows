...
[![R-CMD-check](https://github.com/Bisaloo/test-autoupdate-workflows/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Bisaloo/test-autoupdate-workflows/actions/workflows/R-CMD-check.yaml)
[![Codecov test
coverage](https://codecov.io/gh/Bisaloo/test-autoupdate-workflows/branch/main/graph/badge.svg)](https://app.codecov.io/gh/Bisaloo/test-autoupdate-workflows?branch=main)
...
pak::pak("Bisaloo/test-autoupdate-workflows")
```
...
requests](https://github.com/Bisaloo/test-autoupdate-workflows/pulls).
